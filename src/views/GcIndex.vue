<template>
    <div class="gcgl-container">
        <div class="child-item child-left">
            <div class="animate-card card-static"></div>
            <div class="animate-card">
                <card-tag :con-width="200" :con-height="40" :con-ba-img="gcglTitleTag" @conClick="testGET()">
                    施工准入
                </card-tag>
                ...
                <div ref="SGZRContainer" class="chart-container" style="position: relative; height: 70%"></div>
            </div>
            <div class="animate-card">
                <card-tag :con-width="200" :con-height="40" :con-ba-img="gcglTitleTag" @conClick="testGET()">
                    劳务概况
                </card-tag>
                <div ref="GJQContainer" class="chart-container"></div>
            </div>
        </div>
        <div class="child-item child-middle">
            <div class="animate-card" style="height: 20%">
                ...
                <div ref="ZBCGContainer" class="chart-container" style=""></div>
            </div>
            <div class="animate-card" style="height: 20%">
                <card-tag :con-width="200" :con-height="40" :con-ba-img="gcglTitleTag" @conClick="testGET()">
                    合同管理
                ...
                >
                    ...
                    <div style="width: 50%; position: relative">
                        <div ref="HTGLContainer" class="chart-container"></div>
                    </div>
                </div>
            </div>
            <div class="animate-card" style="height: 30%">
                ...
                <div ref="JLZFContainer" class="chart-container"></div>
            </div>
            <div class="animate-card" style="height: 38%">
                <card-tag :con-width="200" :con-height="40" :con-ba-img="gcglTitleTag" @conClick="testGET()">
                    工程进度
                </card-tag>
                <div ref="GCJDContainerTotal" class="chart-container" style="height: 66px; position: relative"></div>
                <div
                    ref="GCJDContainer"
                    class="chart-container"
                    style="height: calc(65% + 10px); top: calc(35% - 10px); left: 0"
                ></div>
            </div>
        </div>
        <div class="child-item child-right">
            ...
            <div class="animate-card">
                ...
                <div ref="GCDAContainer" class="chart-container" style=""></div>
            </div>
            <div class="animate-card">
                <card-tag :con-width="200" :con-height="40" :con-ba-img="gcglTitleTag" @conClick="testGET()">
                    竣工决算
                </card-tag>
                <div ref="JGJSContainerLeft" class="chart-container" style="width: 50%"></div>
                <div ref="JGJSContainerRight" class="chart-container" style="width: 50%; left: auto; right: 0"></div>
            </div>
        </div>
    </div>
</template>
