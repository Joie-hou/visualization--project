    ...
    <div class="tzgl-container">
        <div class="child-item child-left">
            <div class="animate-card">
                <card-tag :con-ba-img="tzglTitleTag" @conClick="testGET()"> 施工准入 </card-tag>
                <div ref="JAFContainer" class="chart-container"></div>
            </div>
            <div class="animate-card">
                <card-tag :con-ba-img="tzglTitleTag" @conClick="testGET()"> 工程建设其他费 </card-tag>
                <div ref="GJQContainer" class="chart-container"></div>
            </div>
        </div>
        <div class="child-item child-middle"></div>
        <div class="child-item child-right">
            <div class="animate-card">
                <card-tag :con-ba-img="tzglTitleTag" @conClick="testGET()"> 土地使用及拆迁补偿费 </card-tag>
            </div>
            <div class="animate-card">
                <card-tag :con-ba-img="tzglTitleTag" @conClick="testGET()"> 预备费 </card-tag>
            </div>
            <div class="animate-card">
                <card-tag :con-ba-img="tzglTitleTag" @conClick="testGET()"> 建设期贷款利息 </card-tag>
            </div>
        </div>
    </div>
</template>
